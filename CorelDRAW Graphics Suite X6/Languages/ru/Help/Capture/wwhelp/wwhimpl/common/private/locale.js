...
function  WWHCommonMessages_Set_en(ParamMessages)
{
  // Icon Labels
  //
  ParamMessages.mShowNavigationIconLabel = "Show navigation pane";
  ParamMessages.mSyncIconLabel           = "Показать тему в содержании";
  ParamMessages.mPrevIconLabel           = "Предыдущая тема";
  ParamMessages.mNextIconLabel           = "Следующая тема";
