...
function  WWHSearch_HoverTextTranslate(ParamEntryID)
{
  ...
  else
  {
    ...
    //
    HTML += "<table class=\"Search\" width=\"100%\" border=\"0\" cellpadding=\"4\" cellspacing=\"0\">";
    if (Rank.length > 0)
    {
      HTML += "<tr>";
                                    ...
                                    ParamText)
{
  ...
  FormattedText += "<table class=\"Search\" width=\"" + ParamWidth + "\" border=0 cellspacing=0 cellpadding=0 bgcolor=\"" + BackgroundColor + "\">";
  FormattedText += " <tr>";
