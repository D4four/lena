...
function OnMenuToggleFeature(sChkId)
{
    ...
    if ("1" == g_ICAApp.GetProperty("Extras.SA"))
    {
	SetInstallNowButtonState_ExtrasSA();
    }
    else
    {
...
function SetInstallNowButtonState()
{
    ...
    var pBtnInstallNow = document.getElementById("idInstall");
    if (null != pBtnInstallNow)
    {
        ...
        if ( ("1" != g_ICAApp.GetProperty("DRAW")) &&
             ...
             ("1" != g_ICAApp.GetProperty("FONTNAV")) &&
             ("1" != g_ICAApp.GetProperty("CONNECT")))
        {
...
function SetInstallNowButtonState_ExtrasSA()
{
    //disable 'Install Now' button if none of the main applications 
    //are selected for install set it's tooltip
    var pBtnInstallNow = document.getElementById("idInstall");
    ...
    if (null != pBtnInstallNow)
    { 
        if (("1" != g_ICAApp.GetProperty("TEMPLATES")) &&
            ("1" != g_ICAApp.GetProperty("APPEXTRAS")) &&
            ("1" != g_ICAApp.GetProperty("FONTS")) &&
            ("1" != g_ICAApp.GetProperty("CLIPARTIMAGES")) &&
	        ("1" != g_ICAApp.GetProperty("MANUAL")) && 
	        ("1" != g_ICAApp.GetProperty("VIDEOS")))
        {
            pBtnInstallNow.disabled = true;
	    return;
        }
...
{
    if ( ("1" != g_ICAApp.GetProperty("SU")) &&
         ("1" != g_ICAApp.GetProperty("RU")) &&
